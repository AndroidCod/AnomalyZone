// true = [_unit, _weaponSlotID, _ammoItem, _muzzleName] call AZ_Unit_fnc_addWeaponAmmo
...
if ([_weapon, _ammoItem, _muzzleName] call AZ_Item_fnc_Weapon_addAmmo) exitWith
{
	if ((_weaponSlotID == GEAR_SLOT_ID_WEAPON_SECONDARY) and {(_weapon get "config" get "type") == ITEM_TYPE_WEAPON_PRIMARY}) exitWith { true };
