...
// AZ_GearDialog_fnc_clearControlsGroup = 
...
private _allSubCtrls = allControls _ctrlGroup;
{ ctrlDelete _x } forEach _allSubCtrls;
...
private _slots = _container get "itemSlots";
{
	...
	[_display, _idc] call AZ_GUI_fnc_ItemSlot_Delete;	
